...
public class frmMaster extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        mitBuilding = new javax.swing.JMenuItem();
        ...
        mitBuilding.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        mitBuilding.setText("Building");
        mitBuilding.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                mitBuildingActionPerformed(evt);
            }
        });
        jMenu3.add(mitBuilding);
 ...
 try{
            frmStudent obj = new frmStudent(this, true);
            obj.setVisible(true);
    ...
    private void mitBuildingActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mitBuildingActionPerformed
        try{
            dlgBuilding obj = new dlgBuilding(this, true);
            obj.setVisible(true);
            formWindowOpened(null);
    ...
    private javax.swing.JMenuItem mitBuilding;
