...
public class frmCourse extends javax.swing.JDialog {
    ...
    public void showdate() throws SQLException{
        txtID.setText(rs.getString("CourseID"));
        txtName.setText(rs.getString("CourseName"));
    }
     private void inti(){
         try {
            ...
            stmt=con.createStatement(ResultSet.TYPE_SCROLL_SENSITIVE,ResultSet.CONCUR_UPDATABLE);
             System.out.println("Connectioned");
              rs=stmt.executeQuery("select * from tblCourse");
            rs.first();
            showdate();
  ...
  String sql="Delete from tblCourse where CourseID='"+txtID.getText()+"'";       
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                frmCourse dialog = new frmCourse(new javax.swing.JFrame(), true);
